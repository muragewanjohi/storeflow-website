/**
 * Account Orders List Client Component
 * 
 * Displays list of customer orders with status, date, and total
 * This is a copy of the main orders list client, but without the container padding
 * since it's already within the account layout
 */
