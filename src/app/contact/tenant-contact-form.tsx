/**
 * Tenant Contact Form Component
 * 
 * Contact form for tenant stores that sends emails to the tenant's contact email
 */
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...formData,
          tenant_contact: true, // Flag to indicate this is a tenant contact form
        }),
      });
      ...
      toast.success(`Message sent successfully! ${tenantName} will get back to you within 24 hours.`);
    } catch (error) {
      ...
      <div className="min-h-[60vh] flex items-center justify-center px-4 py-20">
        <div className="max-w-md w-full text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Thank You for Contacting {tenantName}!
          </h2>
