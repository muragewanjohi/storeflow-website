 ...
 * 
 * Client component for creating a new price plan
 */
...
export default function CreatePlanForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.message || 'Failed to create price plan');
      }
    ...
    <Card>
      <form onSubmit={handleSubmit}>
        <CardHeader>
          ...
          <CardDescription>
            Configure the basic information for this price plan
          </CardDescription>
        </CardHeader>
