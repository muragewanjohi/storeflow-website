/**
 * Landlord Support Tickets List Client Component
 * 
 * Displays list of landlord support tickets with filtering, search, and actions
 * Similar to tenant tickets list but for landlord/admin view
 */
...
interface LandlordTicketsListClientProps {
...
export default function LandlordTicketsListClient({
  initialTickets,
  initialPagination,
  dbError,
  currentSearchParams,
}: Readonly<LandlordTicketsListClientProps>) {
  ...
  const [category, setCategory] = useState(currentSearchParams.category || 'all');
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              Please run the migration to create the landlord support tickets tables.
              See <code className="bg-muted px-2 py-1 rounded">docs/LANDLORD_SUPPORT_MIGRATION.md</code> for instructions.
            </p>
          </CardContent>
        </Card>
      </div>
                  ...
                  <TableBody>
                    {initialTickets.map((ticket) => (
                      <TableRow key={ticket.id}>
                        ...
                        <TableCell>
                          <div>
                            <div className="font-medium">{ticket.tenant_name}</div>
                            {ticket.tenant_subdomain && (
