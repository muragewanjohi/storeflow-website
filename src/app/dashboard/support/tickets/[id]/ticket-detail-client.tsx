/**
 * Support Ticket Detail Client Component
 * 
...
export default function TicketDetailClient({
  ...
  const handleReply = async () => {
    ...
    try {
      ...
      // Refresh ticket data
      const ticketResponse = await fetch(`/api/support/tickets/${ticket.id}`);
  ...
  const isCustomerMessage = (message: Message) => {
    return message.user_id === ticket.customer?.id;
  };
          ...
          {ticket.status !== 'closed' && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Send a reply to the customer</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
