/**
 * Customer Support Tickets List Client Component
 * 
 * Displays list of customer's support tickets
 */
...
interface CustomerTicketsListClientProps {
...
export default function CustomerTicketsListClient({
  initialTickets,
  initialPagination,
  dbError,
  currentSearchParams,
}: Readonly<CustomerTicketsListClientProps>) {
