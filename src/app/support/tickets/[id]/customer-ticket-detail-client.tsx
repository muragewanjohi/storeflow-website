/**
 * Customer Support Ticket Detail Client Component
 * 
...
interface CustomerTicketDetailClientProps {
...
export default function CustomerTicketDetailClient({
  ...
  error,
  customerId,
}: Readonly<CustomerTicketDetailClientProps>) {
  ...
  const isCustomerMessage = (message: Message) => {
    return message.user_id === customerId;
  };
              ...
              <div className="flex items-start justify-between mb-2">
                <div>
                  <p className="font-medium">
                    {isCustomerMessage(message) ? 'You' : 'Support Team'}
                  </p>
      ...
      {ticket.status !== 'closed' && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Send a reply to the support team</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
