/**
 * Support Ticket Image Upload API Route
 * 
 * Handles POST requests for uploading images to Supabase Storage for support tickets
 */
 ...
 * 
 * Upload image for support ticket to Supabase Storage
 */
