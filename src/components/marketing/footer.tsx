        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="group w-10 h-10 bg-white/20 hover:bg-amber-400 backdrop-blur-sm rounded-lg flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-white/90 hover:text-amber-400 transition-colors">Features</a>
              </li>
              <li>
                <a href="#" className="text-white/90 hover:text-amber-400 transition-colors">Templates</a>
              </li>
              <li>
                <a href="#" className="text-white/90 hover:text-amber-400 transition-colors">Pricing</a>
              </li>
              <li>
                <a href="#" className="text-white/90 hover:text-amber-400 transition-colors">Integrations</a>
              </li>
              <li>
                <a href="#" className="text-white/90 hover:text-amber-400 transition-colors">API Docs</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-white/90 hover:text-amber-400 transition-colors">About Us</a>
              </li>
              <li>
                <a href="#" className="text-white/90 hover:text-amber-400 transition-colors">Careers</a>
              </li>
              <li>
                <a href="#" className="text-white/90 hover:text-amber-400 transition-colors">Blog</a>
              </li>
              <li>
                <a href="#" className="text-white/90 hover:text-amber-400 transition-colors">Press Kit</a>
              </li>
              <li>
                <a href="#" className="text-white/90 hover:text-amber-400 transition-colors">Partners</a>
              </li>
            </ul>
          </div>
